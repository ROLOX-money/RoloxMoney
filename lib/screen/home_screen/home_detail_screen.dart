...
enum InvoiceType { UPCOMING, PAID, DUE, ALL, OVERDUE }
            ...
            child: ListView(shrinkWrap: true, children: [
              Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                AppBar(
                  ...
                  title: Text.rich(
                      TextSpan(
                          ...
                          children: <InlineSpan>[
                            if (widget.invoiceType == InvoiceType.DUE)
                              TextSpan(
                                text: '(${Languages.of(context)?.inNext1Week})',
                                style: Theme.of(context)
                                    .textTheme
                                    .titleSmall!
                                    .copyWith(
                ...
                Padding(
                  ...
                  child: Card(
                    child: ListTile(
                      tileColor: ColorResource.buttonTextColor,
                ...
                ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      DashBoardInvoice invoiceModel = widget.invoiceType ==
                              InvoiceType.ALL
